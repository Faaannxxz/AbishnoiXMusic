...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ᴀʙɪsʜɴᴏɪ ダ ᴍᴜsɪᴄ​")

OWNER_ID = list(
    map(int, getenv("OWNER_ID", "1452219013").split())
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/Abishnoi_bots")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/Abishnoigamer")
...
YTDOWNLOADER = 1
LOG = 2
LOG_FILE_NAME = "AbishnoiXlogs.txt"
adminlist = {}
lyrical = {}
chatstats = {}
userstats = {}
...
if not MUSIC_BOT_NAME.isascii():
    print(
        "[KYA RE LAVDE] - BOHOT FONT LAGANE KA SHAUKH HAI. JAA PHIR Aʙɪsʜɴᴏɪ KO APNI CHUMT DEKE AA"
    )
