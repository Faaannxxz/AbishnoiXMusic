...
from AbishnoiX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from AbishnoiX.core.call import AbishnoiX
from AbishnoiX.utils import seconds_to_min, time_to_seconds
from AbishnoiX.utils.channelplay import get_channeplayCB
from AbishnoiX.utils.database import is_video_allowed
from AbishnoiX.utils.decorators.language import languageCB
from AbishnoiX.utils.decorators.play import PlayWrapper
from AbishnoiX.utils.formatters import formats
from AbishnoiX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from AbishnoiX.utils.inline.playlist import botplaylist_markup
from AbishnoiX.utils.logger import play_logs
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await AbishnoiX.stream_call(url)
...
@app.on_callback_query(
    filters.regex("AbishnoiXPlaylists") & ~BANNED_USERS
)
@languageCB
