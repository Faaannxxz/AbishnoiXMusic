...
from AbishnoiX.misc import HAPP, SUDOERS, XCB
from AbishnoiX.utils.database import (get_active_chats,
                                       remove_active_chat,
                                       remove_active_video_chat)
from AbishnoiX.utils.decorators.language import language
...
async def update_(client, message, _):
    ...
    if len(_final_updates_) > 4096:
        url = await AbishnoiXbin(updates)
