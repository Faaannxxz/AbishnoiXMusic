...
from AbishnoiX.utils import (Alishabin, get_channeplayCB,
                              seconds_to_min)
from AbishnoiX.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from AbishnoiX.utils.decorators.language import language, languageCB
from AbishnoiX.utils.inline import queue_back_markup, queue_markup
...
async def ping_com(client, message: Message, _):
    ...
    if "live_" in file:
        ...
        if videoid == "telegram":
            ...
            IMAGE = get_image(videoid)
    send = (
        "**⌛️ᴅᴜʀᴀᴛɪᴏɴ:** ᴜɴᴋɴᴏᴡɴ ᴅᴜʀᴀᴛɪᴏɴ sᴛʀᴇᴀᴍ\n\nᴄʟɪᴄᴋ ᴏɴ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴡʜᴏʟᴇ ϙᴜᴇᴜᴇᴅ ʟɪsᴛ."
        if DUR == "Unknown"
        else "\nᴄʟɪᴄᴋ ᴏɴ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴡʜᴏʟᴇ ϙᴜᴇᴜᴇᴅ ʟɪsᴛ."
    )
...
🎙**ᴘʟᴀʏɪɴɢ:** {title}
🔖**ᴊᴏɪɴ:** [sᴜᴘᴘᴏʀᴛ](https://t.me/AlishaSupport)
𝄢**ᴛʏᴘᴇ:** {typo}
⚔️**ʀᴇǫᴜᴇsᴛ ʙʏ:** {user}
{send}"""
    upl = (
