...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            image4.text((10, 10), "Powered By @Abishnoi1M", fill="pink", font = font1, align ="left") 
            image4.text((670, 150), "ABISHNOI MUSIC", fill="yellow", font = font2, stroke_width=2, stroke_fill="pink", align ="left") 
